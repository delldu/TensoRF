...
def reconstruction(args):
    ...
    if not args.ndc_ray: # True
        allrays, allrgbs = tensorf.filtering_rays(allrays, allrgbs, bbox_only=True)
    trainingSampler = SimpleSampler(allrays.shape[0], args.batch_size)
    
    Ortho_reg_weight = args.Ortho_weight #  args.Ortho_weight -- 0.0
...
if __name__ == '__main__':
    ...
    #     expname='tensorf_lego_VM', basedir='./log', add_timestamp=0, 
    #     datadir='./data/nerf_synthetic/lego', progress_refresh_rate=10, 
    #     with_depth=False, downsample_train=1.0, downsample_test=1.0, 
    #     model_name='TensorVMSplit', batch_size=4096, n_iters=3000, 
    #     dataset_name='blender', lr_init=0.02, lr_basis=0.001, 
    #     lr_decay_iters=-1, lr_decay_target_ratio=0.1, 
    #     lr_upsample_reset=1, L1_weight_inital=8e-05, 
    #     L1_weight_rest=4e-05, Ortho_weight=0.0, 
    #     TV_weight_density=0.0, TV_weight_app=0.0, 
    #     n_lamb_sigma=[16, 16, 16], n_lamb_sh=[48, 48, 48], 
    #     data_dim_color=27, rm_weight_mask_thre=0.0001, 
    #     alpha_mask_thre=0.0001, distance_scale=25, 
    #     density_shift=-10, shadingMode='MLP_Fea', 
    #     pos_pe=6, view_pe=2, fea_pe=2, featureC=128, 
    ...
    #     fea2denseAct='softplus', ndc_ray=0, nSamples=1000000.0, 
    #     step_ratio=0.5, white_bkgd=False, N_voxel_init=2097156, 
    #     N_voxel_final=16777216, upsamp_list=[2000, 3000, 4000, 5500, 7000], 
