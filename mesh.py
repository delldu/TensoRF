...
def save_points(xyzs, rgbs, filename):
    ...
    for i in torch.cat((xyzs, rgbs), dim=1):
        file.write("{} {} {} {} {} {} 0\n".format
               ...
               int(i[3] * 255.0), int(i[4] * 255.0), int(i[5]*255.0)))
    file.close()
...
def save_input_points(args, tensorf):
    ...
    with torch.no_grad():
        rgb_map, depth_map = renderer(allrays.cpu(), tensorf, chunk=args.batch_size,
                    N_samples=n_samples, white_bg = True, device=device, is_train=False)
