...
def config_parser(cmd=None):
    ...
    parser.add_argument(
        "--progress_refresh_rate", type=int, default=10, help="how many iterations to show psnrs or iters"
    )
    ...
    parser.add_argument(
        "--n_samples", type=int, default=1e6, help="sample point each ray, pass 1e6 if automatic adjust"
    )
